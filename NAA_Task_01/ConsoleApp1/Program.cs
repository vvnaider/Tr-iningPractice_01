...
namespace NAA_Task_01
{
    class Program
    {
        static void Main(string[] args)
        {
            ...
            double crystals = 0;
            bool canConvert = ( crystalBuy * crystalPrice) <= coins; //булевая переменная для конвертирования

            if (canConvert)
            {
                crystals = crystalBuy;
                coins -= crystalBuy * crystalPrice;
                Console.WriteLine("\nВы,- \" Прекрасно.\"" +
            ...
            Console.WriteLine("- * - - - - - - - - - - - - - - - - - - - -  - * - - - - - - - - - - - - - - - - - - - - - * - ");
            Console.WriteLine("\nВаша сумка: {0} кристаллов, {1} золотых монет", crystals, coins);
