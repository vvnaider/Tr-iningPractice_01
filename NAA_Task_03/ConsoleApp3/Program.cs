...
namespace NAA_Task_03
{
    class Program
    {
        static void Main(string[] args)
        {
            ...
            string pass = "Боуи";
            string EnterPass;
            bool resultat = true; //булевая переменная для результата
            ...
            do//цикл
            {
                Console.WriteLine($"> Попыток {3 - mistakes}"); //количество попыток
                EnterPass = Convert.ToString(Console.ReadLine());
                if (EnterPass == "Space Oddity")
                {
            ...
            } while (resultat); //условие завершения выполнено
